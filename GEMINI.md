# LocalQuiz BLE - Gemini Agent Guidelines & Context

Tài liệu này cung cấp hướng dẫn, kiến trúc kỹ thuật và quy chuẩn phát triển dành cho các AI Coding Agents (Antigravity, Gemini CLI, Cursor, Claude Code, Windsurf, Copilot,...) khi đọc và làm việc trên codebase này.
